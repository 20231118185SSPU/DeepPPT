...
| `skills/ppt-master/scripts/dashboard/server.py <path> --daemon` | Start/reuse read-only Dashboard after Step 2 (add `--no-browser` for headless/remote) |
