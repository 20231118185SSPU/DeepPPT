...
- **Animations are preserved** — default page transitions and any explicitly enabled per-element entrance animations are real OOXML and play correctly in the exported video. See [Animations & Transitions](../skills/ppt-master/references/animations.md).
