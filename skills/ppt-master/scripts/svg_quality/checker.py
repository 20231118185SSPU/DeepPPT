    ...
    def check_file(
        ...
        *,
        ...
        try:
            ...
            # DeepPPT2 extension checks (migrated from the pre-refactor checker):
            # WCAG contrast, narrative consistency, spacing/overlap/whitespace
            # heuristics, and the legacy safe-margin layout check. Advisory-only;
            # the contract checks above remain the authoritative gate.
            try:
                from .deepppt_extensions import run_extensions
                run_extensions(
                    content,
                    svg_path,
                    result,
