...
Purpose:
    Generate PPT Master image assets through OpenRouter chat-completions models
    that return image data.

Used by:
    image_gen.py when the selected image backend is "openrouter".

Configuration:
    OPENROUTER_API_KEY   Required API key.
    OPENROUTER_BASE_URL  Optional API base URL override.
