...
| `workflow satellite` | Native PPTX enhancement (Enhance route) | `native_enhance_pptx.py`, `native_enhance_pptx_core.py`, `native_narration_pptx.py`, `native_payloads.py`, `pptx_animations.py`, `pptx_delivery_check.py`, `pptx_effects.py`, `pptx_opc_validation.py`, `pptx_transitions.py` | [docs/pptx-transitions.md](./docs/pptx-transitions.md), `../workflows/native-enhance-pptx.md` |
