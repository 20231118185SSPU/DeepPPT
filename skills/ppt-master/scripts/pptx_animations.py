...
# --- Extracted modules (system-optimization Phase 6 split) ---
# Constants/pools and effect normalization now live in animation_constants.py /
# animation_effects.py; this file keeps the full public import surface and the
# timing/validation groups.
from animation_constants import (  # noqa: E402
    ...
    NATIVE_ANIMATIONS,
    NATIVE_ANIMATION_KEYS,
    _AUDIO_REL_TYPE,
    _DML_NS,
    _INTERPOLATED_BEHAVIOR_TAGS,
    _MC_NS,
    _NODE_TYPE_TRIGGERS,
    _PACKAGE_REL_NS,
...
from animation_effects import (  # noqa: E402
    ...
    AnimationTarget,
    _local_name,
    _normalize_powerpoint_font_name,
    _normalize_target,
    _positive_shape_id,
    _qn,
    _seconds_to_ms,
    ...
    _normalize_animation_color,
    _normalize_repeat_count,
    _normalize_after_effect,
    _normalize_sound,
    _finite_number,
    _normalize_target_mapping,
    _optional_bool,
    _optional_ratio,
    _non_negative_milliseconds,
)
