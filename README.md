...
> 基于 [ppt-master](https://github.com/hugohe3/ppt-master) 扩展开发，增加深度调研、统一 Dashboard、叙事驱动模板、双轨图片生成、视觉审查和质量门禁等能力。
...
| 门禁 | 基础脚本校验 | confirm / research / asset / harness / e2e 多阶段质量门禁 |
